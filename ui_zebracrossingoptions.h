...
public:
    ...
    void setupUi(QWidget *ZebraCrossingOptions)
    {
        ...
        PedestrianEdit = new QLineEdit(ZebraCrossingOptions);
        PedestrianEdit->setObjectName(QStringLiteral("PedestrianEdit"));

        horizontalLayout->addWidget(PedestrianEdit);
    ...
    void retranslateUi(QWidget *ZebraCrossingOptions)
    {
        ...
        Pedestrianlabel->setText(QApplication::translate("ZebraCrossingOptions", "Pedestrian per Minute", Q_NULLPTR));
