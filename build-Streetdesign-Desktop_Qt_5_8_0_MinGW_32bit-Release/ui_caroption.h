...
public:
    ...
    void setupUi(QWidget *CarOption)
    {
        ...
        label_2 = new QLabel(CarOption);
        label_2->setObjectName(QStringLiteral("label_2"));

        horizontalLayout->addWidget(label_2);

        horizontalSlider = new QSlider(CarOption);
        horizontalSlider->setObjectName(QStringLiteral("horizontalSlider"));
        horizontalSlider->setOrientation(Qt::Horizontal);

        horizontalLayout->addWidget(horizontalSlider);

        CarsPerMinuteLabel = new QLabel(CarOption);
        CarsPerMinuteLabel->setObjectName(QStringLiteral("CarsPerMinuteLabel"));

        horizontalLayout->addWidget(CarsPerMinuteLabel);
    ...
    void retranslateUi(QWidget *CarOption)
    {
        ...
        label_2->setText(QApplication::translate("CarOption", "Cars per Minute", Q_NULLPTR));
        CarsPerMinuteLabel->setText(QApplication::translate("CarOption", "30", Q_NULLPTR));
