...
QT_MOC_LITERAL(3, 22, 13) // "MouseOnObject"

    },
    "MyLabel\0MousePressed\0\0MouseOnObject"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::MouseOnObject)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::MousePressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void MyLabel::MouseOnObject()
{
