...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionRefuge = new QAction(MainWindow);
        actionRefuge->setObjectName(QStringLiteral("actionRefuge"));
        ...
        buildimage->setPixmap(QPixmap(QString::fromUtf8(":/pictures/points.png")));
        ...
        menuAdd->addAction(actionRefuge);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionRefuge->setText(QApplication::translate("MainWindow", "Refuge", Q_NULLPTR));
